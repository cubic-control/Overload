...
import com.cubic_control.Models.ModelPlayerSlim;
...
public class RenderZombieAlex extends RenderLiving
{
    ...
    private static ResourceLocation Resource = new ResourceLocation(RefStrings.MODID + ":textures/mobs/zombie/Zombie_Alex.png");
    ...
    public RenderZombieAlex(ModelBase par1ModelBase, float par2){
        this(par1ModelBase, par2, 1.0F);
    }

    public RenderZombieAlex(ModelBase par1ModelBase, float par2, float par3)
    {
