...
public abstract class BlockBluestoneDiode extends BlockRedstoneDiode
{
    ...
    {
        return p_149691_1_ == 0 ? (this.isRepeaterPowered ? MBlocks.bluestone_torch.getBlockTextureFromSide(p_149691_1_) : MBlocks.unlit_bluestone_torch.getBlockTextureFromSide(p_149691_1_)) : (p_149691_1_ == 1 ? this.blockIcon : Blocks.double_stone_slab.getBlockTextureFromSide(1));
    }
    ...
    protected int getInputStrength(World p_149903_1_, int p_149903_2_, int p_149903_3_, int p_149903_4_, int p_149903_5_)
    {
        ...
        return l1 >= 15 ? l1 : Math.max(l1, p_149903_1_.getBlock(j1, p_149903_3_, k1) == MBlocks.bluestone_wire ? p_149903_1_.getBlockMetadata(j1, p_149903_3_, k1) : 0);
    }
    ...
    protected int func_149913_i(IBlockAccess p_149913_1_, int p_149913_2_, int p_149913_3_, int p_149913_4_, int p_149913_5_)
    {
        ...
        return this.func_149908_a(block) ? (block == MBlocks.bluestone_wire ? p_149913_1_.getBlockMetadata(p_149913_2_, p_149913_3_, p_149913_4_) : p_149913_1_.isBlockProvidingPowerTo(p_149913_2_, p_149913_3_, p_149913_4_, p_149913_5_)) : 0;
    }
    ...
    {
    	//TODO:Create unpowered_comparator
        return ((BlockBluestoneDiode) MBlocks.unpowered_repeater).func_149907_e(p_149909_0_) || Blocks.unpowered_comparator.func_149907_e(p_149909_0_);
    }
