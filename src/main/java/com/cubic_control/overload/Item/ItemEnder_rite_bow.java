...
public class ItemEnder_rite_bow extends Item
{
    ...
    public ItemEnder_rite_bow(String name)
    {
        this.maxStackSize = 1;
        this.setMaxDamage(385);
        this.setCreativeTab(MCreativeTabs.tabWeapons);
        this.setUnlocalizedName(name);
        this.setTextureName(RefStrings.MODID + ":Ender-rite_bow");
        this.setFull3D();
    ...
    {
        this.itemIcon = parIconRegister.registerIcon(RefStrings.MODID + ":" + "Ender-rite_bow" + "_standby");
        this.iconArray = new IIcon[SyringePullIconNameArray.length];

        for (int i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = parIconRegister.registerIcon(RefStrings.MODID + ":" + "Ender-rite_bow" +  "_" + SyringePullIconNameArray[i]);
        }
    }
