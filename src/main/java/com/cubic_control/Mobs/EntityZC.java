...
public class EntityZC extends EntityZombie
{
    ...
    protected void addRandomArmor()
    {
        ...
        if (this.rand.nextFloat() < (this.worldObj.difficultySetting == EnumDifficulty.HARD ? 0.05F : 0.01F))
        {
            ...
            if (i == 0)
            {
                this.setCurrentItemOrArmor(0, new ItemStack(MItems.ender_rite_sword));
            }
            else
            {
                this.setCurrentItemOrArmor(0, new ItemStack(MItems.ender_rite_spade));
            }
        }
    }
    ...
    public void onKillEntity(EntityLivingBase par1EntityLivingBase)
    {
        ...
        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && par1EntityLivingBase instanceof EntityVillager)
        {
            ...
            EntityZC entityzombie = new EntityZC(this.worldObj);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        {
            p_110161_1_1 = new EntityZC.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_110161_1_1 instanceof EntityZC.GroupData)
        {
            EntityZC.GroupData groupdata = (EntityZC.GroupData)p_110161_1_1;
