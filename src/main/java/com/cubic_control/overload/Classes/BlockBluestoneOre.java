...
public class BlockBluestoneOre extends Block
{
    ...
    private void func_150185_e(World p_150185_1_, int p_150185_2_, int p_150185_3_, int p_150185_4_)
    {
        ...
        if (this == MBlocks.bluestone_ore)
        {
            p_150185_1_.setBlock(p_150185_2_, p_150185_3_, p_150185_4_, MBlocks.lit_bluestone_ore);
        }
    }
    ...
    {
        if (this == MBlocks.lit_bluestone_ore)
        {
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, MBlocks.bluestone_ore);
        }
    }
    ...
    {
        return new ItemStack(MBlocks.bluestone_ore);
    }
}