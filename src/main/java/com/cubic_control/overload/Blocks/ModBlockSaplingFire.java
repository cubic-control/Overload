...
public class ModBlockSaplingFire extends BlockSapling implements IGrowable{
	...
	public boolean isValidPosition(World world, int x, int y, int z, int metadata)
	{
		...
		{
		default:
			return block == MBlocks.fire_grass || block == MBlocks.fire_dirt || block.canSustainPlant(world, x, y - 1, z, ForgeDirection.UP, this);
		}
	}
	...
	public boolean canSustainPlant(IBlockAccess world, int x, int y, int z, ForgeDirection direction, IPlantable plantable) {
		if (world.getBlock(x, y, z) == MBlocks.fire_dirt) {
			return true;
		}
		if (world.getBlock(x, y, z) == MBlocks.fire_grass) {
			return true;
		}
		else {
			return false;
