...
public class ModItemMonsterPlacer extends ItemMonsterPlacer
{
    ...
    public ModItemMonsterPlacer(String parEntityToSpawnName, int parPrimaryColor, int parSecondaryColor, String parSpawnName){
        ...
        maxStackSize = 64;
        setCreativeTab(MCreativeTabs.tabMisc);
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
       ...
       {
            entityToSpawnNameFull = RefStrings.MODID+"."+entityToSpawnName;
