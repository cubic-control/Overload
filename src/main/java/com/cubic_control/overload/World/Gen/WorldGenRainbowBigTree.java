...
public class WorldGenRainbowBigTree extends WorldGenRainbowAbstractTree
{
	private static Block log = MBlocks.brown_block;
	private static Block leaves = MBlocks.lime_block;
	...
	public WorldGenRainbowBigTree(boolean p_i2008_1_, int treeHeight, int trunkWidth, int leavesWidthFromBase)
	{
		super(p_i2008_1_);
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.func_150529_a(par1, l, par3, f, (byte)1, MBlocks.lime_block);
        }
    }
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.func_150530_a(aint, aint2, MBlocks.brown_block);
            }
        }
    }
	...
	boolean validTreeLocation()
	{
		...
		if (block == MBlocks.green_block || block == MBlocks.brown_block) {
			isSoil = true;
		}
