...
public class EntityZombieJeb extends EntityZombie
{
    ...
    public EntityZombieJeb(World par1World)
    {
        super(par1World);
    ...
    public void onKillEntity(EntityLivingBase par1EntityLivingBase)
    {
        ...
        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && par1EntityLivingBase instanceof EntityVillager)
        {
            ...
            EntityZombieJeb entityzombie = new EntityZombieJeb(this.worldObj);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        {
            p_110161_1_1 = new EntityZombieJeb.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_110161_1_1 instanceof EntityZombieJeb.GroupData)
        {
            EntityZombieJeb.GroupData groupdata = (EntityZombieJeb.GroupData)p_110161_1_1;
