...
import com.cubic_control.Classes.BlockModLeaves;
...
public class ModBlockLeavesIce extends BlockModLeaves
{
	
	//TODO: block renders see through back/adjcent faces
	
    public static final String[][] field_150130_N = new String[][] {{"leaves_ice"}, {"leaves_ice_opaque"}};
    public static final String[] field_150131_O = new String[] {"ice"};
  
    
    private static final String __OBFID = "CL_00000280";
    
    public ModBlockLeavesIce(Material material, String name){
    ...
    {
        return Item.getItemFromBlock(MBlocks.ice_sapling);
    }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        for (int i = 0; i < field_150130_N.length; ++i)
        {
            ...
            {
                this.field_150129_M[i][j] = p_149651_1_.registerIcon(RefStrings.MODID + ":" + field_150130_N[i][j]);
            }
        }
    }
