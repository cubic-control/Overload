...
public class BiomeDecoratorHelper {
    ...
    protected static void decorateBiome(BiomeGenBase biome) {
        ...
        if(biome == MBiomes.NightmareForest){
            BiomeDecoratorMod.howMenyTrees = ModBiomeNightmareForest.treesPerChunk;
            int i = BiomeDecoratorMod.howMenyTrees;
            /** Chunk Postions **/
            int chunkX;
            int chunkZ;
        ...
        if(biome == MBiomes.RainbowPlains){
        	int i = BiomeDecoratorMod.howMenyTrees;
            /** Chunk Postions **/
            int chunkX;
            int chunkZ;
        ...
        if(biome == MBiomes.RainbowForest){
            BiomeDecoratorMod.howMenyTrees = ModBiomeRainbowForest.treesPerChunk;
            int i = BiomeDecoratorMod.howMenyTrees;
            /** Chunk Postions **/
            int chunkX;
            int chunkZ;
            ...
            for(int a = 0; a < i; ++a){
                if(i == BiomeDecoratorMod.randomGenerator.nextInt(8)){
                    ...
                    block = BiomeDecoratorMod.currentWorld.getBlock(chunkX, y, chunkZ);
                    blockA = BiomeDecoratorMod.currentWorld.getBlock(chunkX, y - 1, chunkZ);
                    if(block != Blocks.air || block != MBlocks.blue_block){
                        if(blockA != Blocks.air || blockA != MBlocks.blue_block){
                            BiomeDecoratorMod.SmallRainbowTree.generate(BiomeDecoratorMod.currentWorld, BiomeDecoratorMod.randomGenerator, chunkX, y, chunkZ);
                        }
                    }
                }
                /** Generates Big tree **/
                if(i == BiomeDecoratorMod.randomGenerator.nextInt(15)){
                    ...
                    if(block != Blocks.air || block != MBlocks.blue_block){
                        if(blockA != Blocks.air || blockA != MBlocks.blue_block){
                            BiomeDecoratorMod.BigRainbowTree.generate(BiomeDecoratorMod.currentWorld, BiomeDecoratorMod.randomGenerator, chunkX, y, chunkZ);
                        }
                    }
                }
            }
