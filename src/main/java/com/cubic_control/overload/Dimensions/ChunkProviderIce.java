...
public class ChunkProviderIce implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderIce(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_147424_3_[j3 += short1] = MBlocks.ice_stone;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
