...
public class EntityZombieSuperSonic10 extends EntityZombie
{
    ...
    public EntityZombieSuperSonic10(World par1World)
    {
        super(par1World);
        ...
        this.setCustomNameTag("super_sonic_10");
    }

    protected void applyEntityAttributes()
    {
        super.applyEntityAttributes();
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(30.2D);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.23000000528232513D);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(3.3D);
    ...
    public void onKillEntity(EntityLivingBase par1EntityLivingBase)
    {
        ...
        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && par1EntityLivingBase instanceof EntityVillager)
        {
            ...
            EntityZombieSuperSonic10 entityzombie = new EntityZombieSuperSonic10(this.worldObj);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        {
            p_110161_1_1 = new EntityZombieSuperSonic10.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_110161_1_1 instanceof EntityZombieSuperSonic10.GroupData)
        {
            EntityZombieSuperSonic10.GroupData groupdata = (EntityZombieSuperSonic10.GroupData)p_110161_1_1;
