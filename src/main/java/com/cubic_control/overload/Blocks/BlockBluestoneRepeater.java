...
import com.cubic_control.overload.Classes.BlockBluestoneDiode;
...
public class BlockBluestoneRepeater extends BlockRedstoneRepeater
{
    ...
    protected BlockBluestoneRepeater(boolean p_i45424_1_, String name)
    {
        super(p_i45424_1_);
    ...
    {
        return (BlockBluestoneDiode) MBlocks.powered_repeater;
    }

    @Override
    protected BlockRedstoneDiode getBlockUnpowered()
    {
        return (BlockBluestoneDiode) MBlocks.unpowered_repeater;
    }

    @Override
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
        return MItems.repeater;
    }
