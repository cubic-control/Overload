...
public class EntityFireWarrior extends EntityFireBase{

	public EntityFireWarrior(World par1World) {
		super(par1World);
		...
		this.tasks.addTask(11, new EntityAIWatchClosest(this, EntityIceWarrior.class, 8.0F));
