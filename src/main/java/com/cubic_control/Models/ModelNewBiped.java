...
public class ModelNewBiped extends ModelBase
{
    ...
    public ModelNewBiped()
    {
        this(0.0F);
    }

    public ModelNewBiped(float par1)
    {
        this(par1, 0.0F, 64, 32);
    }

    public ModelNewBiped(float par1, float par2, int par3, int par4)
    {
    	textureWidth = 64;
        textureHeight = 64;
          ...
          bipedLeftArm.addBox(-1F, -2F, -2F, 4, 4, 4);
