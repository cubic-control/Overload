...
public class ItemScythe extends Item
{
    ...
    public ItemScythe(Item.ToolMaterial p_i45356_1_)
    {
        this.field_150933_b = p_i45356_1_;
        this.maxStackSize = 1;
        this.setMaxDamage(p_i45356_1_.getMaxUses() + 1945);
        this.setCreativeTab(CreativeTabs.tabCombat);
        this.field_150934_a = 11.5F + p_i45356_1_.getDamageVsEntity();
    }
    ...
    {
        return this.field_150933_b.getEnchantability() + 84;
    }
