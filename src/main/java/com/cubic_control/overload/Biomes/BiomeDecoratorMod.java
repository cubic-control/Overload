...
import com.cubic_control.overload.World.Gen.WorldGenDeadBigTree;
import com.cubic_control.overload.World.Gen.WorldGenDeadTrees;
import com.cubic_control.overload.World.Gen.WorldGenFireBigTree;
import com.cubic_control.overload.World.Gen.WorldGenFireTrees;
...
import com.cubic_control.overload.World.Gen.WorldGenRainbowBigTree;
import com.cubic_control.overload.World.Gen.WorldGenRainbowTrees;
...
public class BiomeDecoratorMod extends BiomeDecorator
{
	...
	public static WorldGenRainbowTrees SmallRainbowTree;
	public static WorldGenRainbowBigTree BigRainbowTree;
	...
	public BiomeDecoratorMod() {
		...
		SmallRainbowTree = new WorldGenRainbowTrees(true);
		BigRainbowTree = new WorldGenRainbowBigTree(true, 10, 1, 5);
