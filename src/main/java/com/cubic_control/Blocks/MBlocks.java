...
import com.cubic_control.Blocks.ModBlockLogFire;
import com.cubic_control.Blocks.ModBlockLogIce;
...
public class MBlocks {
	...
	public static void InitializeBlock(){
		...
		fire_grass = new ModBlockGrassFire(Material.rock, "fire_grass");
