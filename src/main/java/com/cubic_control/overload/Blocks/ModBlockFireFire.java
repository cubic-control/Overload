...
public class ModBlockFireFire extends BlockFire
{
    @Deprecated
    ...
    protected ModBlockFireFire(String string)
    {
        super();
    ...
    {
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.planks), 5, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.double_wooden_slab), 5, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.wooden_slab), 5, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.fence), 5, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.oak_stairs), 5, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.birch_stairs), 5, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.spruce_stairs), 5, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.jungle_stairs), 5, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.log), 5, 5);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.log2), 5, 5);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.leaves), 30, 60);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.leaves2), 30, 60);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.bookshelf), 30, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.tnt), 15, 100);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.tallgrass), 60, 100);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.double_plant), 60, 100);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.yellow_flower), 60, 100);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.red_flower), 60, 100);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.wool), 30, 60);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.vine), 15, 100);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.coal_block), 5, 5);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.hay_block), 60, 20);
        ((BlockFire) MBlocks.burned_fire).func_149842_a(getIdFromBlock(Blocks.carpet), 60, 20);
    }
    ...
    public void onBlockAdded(World world, int x, int y, int z){
        if (!SomeModUtils.isValidDimension(world) || !ModBlockPortalFire.getPortalSize(world, x, y, z)){
            if (!World.doesBlockHaveSolidTopSurface(world, x, y - 1, z) && !this.canNeighborBurn(world, x, y, z)){
                world.setBlockToAir(x, y, z);
            } else {
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_) && !((BlockFire) MBlocks.burned_fire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_, UP))
        {
            if (((BlockFire) MBlocks.burned_fire).canCatchFire(p_149734_1_, p_149734_2_ - 1, p_149734_3_, p_149734_4_, EAST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockFire) MBlocks.burned_fire).canCatchFire(p_149734_1_, p_149734_2_ + 1, p_149734_3_, p_149734_4_, WEST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockFire) MBlocks.burned_fire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ - 1, SOUTH))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockFire) MBlocks.burned_fire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ + 1, NORTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
            ...
            if (((BlockFire) MBlocks.burned_fire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ + 1, p_149734_4_, DOWN))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
