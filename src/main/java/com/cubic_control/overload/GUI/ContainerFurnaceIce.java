...
public class ContainerFurnaceIce extends Container{
    private TileEntityFurnaceIce tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    
    public ContainerFurnaceIce(InventoryPlayer player, World world, int x, int y, int z) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2) {
        ...
        if(slot != null && slot.getHasStack()){
            ...
            if(par2 == 2){
                ...
                }else if (TileEntityFurnaceIce.isItemFuel(itemstack1)){
