...
public class WorldProviderRainbow extends WorldProvider{
	...
	{
		setDimension(DimensionIDs.Rainbow_Realm);
		this.saveFolder = ("DIM" + DimensionIDs.Rainbow_Realm);
	}
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderRainbow(this.worldObj, this.worldObj.getSeed(), true);
	}

	@Override
	/** tells Minecraft to use our new WorldChunkManager **/
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerRainbow(worldObj.getSeed(), terrainType);
		this.dimensionId = DimensionIDs.Rainbow_Realm;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(DimensionIDs.Rainbow_Realm);
	}
