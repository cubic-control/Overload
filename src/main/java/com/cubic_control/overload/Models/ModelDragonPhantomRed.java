...
public class ModelDragonPhantomRed extends ModelBase
{
    ...
    public ModelDragonPhantomRed(float par1)
    {
    ...
    {
        GL11.glPushMatrix();
        EntityDragonPhantomRed entitydragon = (EntityDragonPhantomRed)par1Entity;
