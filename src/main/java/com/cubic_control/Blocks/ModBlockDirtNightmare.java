...
public class ModBlockDirtNightmare extends Block
{
    ...
    protected ModBlockDirtNightmare(String name)
    {
    ...
    public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_, int p_149673_3_, int p_149673_4_, int p_149673_5_)
    {
        ...
        if (i1 == 2)
        {
            ...
            if (p_149673_5_ != 0)
            {
                ...
                {
                    return MBlocks.nightmare_grass.getIcon(p_149673_1_, p_149673_2_, p_149673_3_, p_149673_4_, p_149673_5_);
                }

                Block block = p_149673_1_.getBlock(p_149673_2_, p_149673_3_ + 1, p_149673_4_);

                if (block != MBlocks.nightmare_dirt && block != MBlocks.nightmare_grass)
                {
                    return this.field_150010_M;
                }
            }
