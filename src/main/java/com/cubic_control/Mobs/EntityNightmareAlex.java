...
public class EntityNightmareAlex extends EntityMob{

	public EntityNightmareAlex(World par1World) {
		super(par1World);
	...
	protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.25500000000000000D);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(7.0D);
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(81.0D);
    }
