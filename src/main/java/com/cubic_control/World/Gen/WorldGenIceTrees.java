package com.cubic_control.World.Gen;
...
public class WorldGenIceTrees extends WorldGenIceAbstractTree
{
    ...
    public WorldGenIceTrees(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 6, leaves, wood, false);
    }

    public WorldGenIceTrees(boolean p_i2028_1_, int minTreeHeight, Block metaWood, Block metaLeaves, boolean growVines)
    {
        super(p_i2028_1_);
        this.minTreeHeight = minTreeHeight;
        WorldGenIceTrees.wood = metaWood;
        WorldGenIceTrees.leaves = metaLeaves;
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        ...
        if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP, (BlockSapling)MBlocks.ice_sapling);
                if (isSoil && p_76484_4_ < 256 - l - 1)
                {
                        ...
                        for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2)
                        {
                            ...
                            for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, MBlocks.ice_leaves, 0);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_, MBlocks.ice_log, 0);
