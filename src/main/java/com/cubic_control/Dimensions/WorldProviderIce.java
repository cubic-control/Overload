...
public class WorldProviderIce extends WorldProvider{
	
	public static String saveFolder;
	
	public WorldProviderIce()
	{
		setDimension(DimensionIDs.Realm_of_Ice);
		this.saveFolder = ("DIM" + DimensionIDs.Realm_of_Ice);
	}
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderIce(this.worldObj, this.worldObj.getSeed(), true);
	}

	@Override
	/** tells Minecraft to use our new WorldChunkManager **/
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerIce(worldObj.getSeed(), terrainType);
		this.dimensionId = DimensionIDs.Realm_of_Ice;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(DimensionIDs.Realm_of_Ice);
	}
