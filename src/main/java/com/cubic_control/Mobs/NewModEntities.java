...
import com.cubic_control.Biomes.ModBiomeDictionary;
import com.cubic_control.Biomes.ModBiomeDictionary.ModType;
	...
	public static void preinit(){
		...
		for (int i = 0; i < BiomeGenBase.getBiomeGenArray().length; i++)
	    {
			if (BiomeGenBase.getBiomeGenArray()[i] != null)
			{
				...
				EntityRegistry.addSpawn(EntityZombieYoutuber.class, 50, 1, 8, EnumCreatureType.monster, zombieSpawnBiomes);
				...
				EntityRegistry.addSpawn(EntityJeff.class, 5, 1, 2, EnumCreatureType.monster, zombieSpawnBiomes);
				...
				EntityRegistry.addSpawn(EntityStalker.class, 5, 1, 3, EnumCreatureType.ambient, BiomeGenBase.getBiomeGenArray()[i]);
				//NIGHTMARES
