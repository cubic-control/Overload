...
public class EntityZombieNotch extends EntityZombie
{
    ...
    public void onKillEntity(EntityLivingBase par1EntityLivingBase)
    {
        ...
        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && par1EntityLivingBase instanceof EntityVillager)
        {
            ...
            EntityZombieNotch entityzombie = new EntityZombieNotch(this.worldObj);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        {
            p_110161_1_1 = new EntityZombieNotch.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_110161_1_1 instanceof EntityZombieNotch.GroupData)
        {
            EntityZombieNotch.GroupData groupdata = (EntityZombieNotch.GroupData)p_110161_1_1;
