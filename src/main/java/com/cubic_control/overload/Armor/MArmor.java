...
public class MArmor {
	...
	private static void InitializeItem() {
		...
		/*Light*/
		light_helmet = new LightArmor(ModArmorMaterial.light_armor, MainRegistry.proxy.addArmor("light_armor"), 0, "light_helmet");
		light_chestplate = new LightArmor(ModArmorMaterial.light_armor, MainRegistry.proxy.addArmor("light_armor"), 1, "light_chestplate");
		light_leggings = new LightArmor(ModArmorMaterial.light_armor, MainRegistry.proxy.addArmor("light_armor"), 2, "light_leggings");
		light_boots = new LightArmor(ModArmorMaterial.light_armor, MainRegistry.proxy.addArmor("light_armor"), 3, "light_boots");
		/*Death*/
