...
public class ModelDragonPhantomBlue extends ModelBase
{
    ...
    public ModelDragonPhantomBlue(float par1)
    {
    ...
    {
        GL11.glPushMatrix();
        EntityDragonPhantomBlue entitydragon = (EntityDragonPhantomBlue)par1Entity;
