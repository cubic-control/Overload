...
public class EntityNightmareHerobrine extends EntityMob{

	public EntityNightmareHerobrine(World par1World) {
		super(par1World);
	...
	protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.32500000000000000D);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(9.5D);
