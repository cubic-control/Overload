...
public class ModBlockWorkbenchIce extends BlockWorkbench{
	...
	public static Block BLOCK = MBlocks.ice_planks;
	public static int ID = 1;
	
	protected ModBlockWorkbenchIce(String name, float f1, float f2){
		this.setHardness(f1);
