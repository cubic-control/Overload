...
public class WorldChunkManagerRainbow extends WorldChunkManager {
	...
	public WorldChunkManagerRainbow()
	{
	...
	public WorldChunkManagerRainbow(long seed, WorldType worldType)
	{
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = RainbowGenLayer.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerRainbow(World world)
	{
