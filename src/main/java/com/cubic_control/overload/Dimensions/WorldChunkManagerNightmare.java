...
public class WorldChunkManagerNightmare extends WorldChunkManager {
	...
	public WorldChunkManagerNightmare(long seed, WorldType worldType)
	{
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = NightmareGenLayer.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerNightmare(World world)
	{
