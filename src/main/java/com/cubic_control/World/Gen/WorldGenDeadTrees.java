...
public class WorldGenDeadTrees extends WorldGenFireAbstractTree
{
    ...
    public WorldGenDeadTrees(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 6, leaves, wood, false);
    }

    public WorldGenDeadTrees(boolean p_i2028_1_, int minTreeHeight, Block metaWood, Block metaLeaves, boolean growVines)
    {
        super(p_i2028_1_);
        this.minTreeHeight = minTreeHeight;
        WorldGenDeadTrees.wood = metaWood;
        WorldGenDeadTrees.leaves = metaLeaves;
                        ...
                        for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2)
                        {
                            ...
                            for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, Blocks.air, 0);
                                    }
                                }
                            }
                        }
