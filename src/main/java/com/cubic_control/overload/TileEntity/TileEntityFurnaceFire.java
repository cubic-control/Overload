...
import com.cubic_control.overload.Blocks.ModBlockFurnaceFire;

import cpw.mods.fml.common.registry.GameRegistry;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class TileEntityFurnaceFire extends TileEntity implements ISidedInventory {
    ...
    public int furnaceBurnSpeed = 100; //Speed at which the furnace cooks.
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.localizedName : "container.fire_furnace";
    }
    @Override
    ...
    public void updateEntity() {
        ...
        if(!this.worldObj.isRemote){
            ...
            if(flag != this.furnaceBurnTime > 0){
                flag1 = true;
                ModBlockFurnaceFire.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
        if(flag1){
            this.markDirty();
