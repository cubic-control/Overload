...
public class ModelDragonPhantomLightBlue extends ModelBase
{
    ...
    public ModelDragonPhantomLightBlue(float par1)
    {
    ...
    {
        GL11.glPushMatrix();
        EntityDragonPhantomLightBlue entitydragon = (EntityDragonPhantomLightBlue)par1Entity;
