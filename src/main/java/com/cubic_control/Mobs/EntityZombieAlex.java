...
public class EntityZombieAlex extends EntityZombie{
	 protected static final IAttribute field_110186_bp = (new RangedAttribute("zombie.spawnReinforcements", 0.0D, 0.0D, 1.0D)).setDescription("Spawn Reinforcements Chance");
	    ...
	    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
	    {
	        ...
	        if (this.isChild())
	        {
	            par1NBTTagCompound.setBoolean("IsBaby", false);
	        }

	        if (this.isVillager())
	        {
	            par1NBTTagCompound.setBoolean("IsVillager", false);
	        }
	    ...
	    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
	    {
	        ...
	        {
	            p_110161_1_1 = new EntityZombieAlex.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
	        }

	        if (p_110161_1_1 instanceof EntityZombieAlex.GroupData)
	        {
	        	EntityZombieAlex.GroupData groupdata = (EntityZombieAlex.GroupData)p_110161_1_1;
