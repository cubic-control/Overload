...
public class ModelDragonPhantomYellow extends ModelBase
{
    ...
    public ModelDragonPhantomYellow(float par1)
    {
    ...
    {
        GL11.glPushMatrix();
        EntityDragonPhantomYellow entitydragon = (EntityDragonPhantomYellow)par1Entity;
