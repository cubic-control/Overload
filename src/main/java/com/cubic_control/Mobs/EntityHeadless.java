...
import com.cubic_control.Util.EntityUtil;
import com.cubic_control.Util.SpawnUtil;
...
public class EntityHeadless extends EntityMob{
	...
	public void EntityHitList(){
		...
		this.tasks.addTask(2, new EntityAIAttackOnCollide(this, EntityFakeHeadless.class, 1.0D, true));
