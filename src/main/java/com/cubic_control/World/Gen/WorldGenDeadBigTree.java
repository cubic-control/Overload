...
public class WorldGenDeadBigTree extends WorldGenDeadAbstractTree
{
	private static Block log = Blocks.log;
	private static Block leaves = Blocks.air;
	...
	public WorldGenDeadBigTree(boolean p_i2008_1_, int treeHeight, int trunkWidth, int leavesWidthFromBase)
	{
		super(p_i2008_1_);
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.func_150529_a(par1, l, par3, f, (byte)1, Blocks.air);
        }
    }
