...
public class ModelDragonPhantomWhite extends ModelBase
{
    ...
    public ModelDragonPhantomWhite(float par1)
    {
    ...
    {
        GL11.glPushMatrix();
        EntityDragonPhantomWhite entitydragon = (EntityDragonPhantomWhite)par1Entity;
