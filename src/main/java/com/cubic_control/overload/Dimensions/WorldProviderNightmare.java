...
public class WorldProviderNightmare extends WorldProvider{
	...
	{
		setDimension(DimensionIDs.Nightmare_Realm);
		this.saveFolder = ("DIM" + DimensionIDs.Nightmare_Realm);
	}
	...
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerNightmare(worldObj.getSeed(), terrainType);
		this.dimensionId = DimensionIDs.Nightmare_Realm;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(DimensionIDs.Nightmare_Realm);
	}
