...
public class EntityZombieDinnerbone extends EntityZombie
{
    ...
    public EntityZombieDinnerbone(World par1World)
    {
        super(par1World);
        ...
        this.setCustomNameTag("Dinnerbone");
    }
    ...
    public void onKillEntity(EntityLivingBase par1EntityLivingBase)
    {
        ...
        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && par1EntityLivingBase instanceof EntityVillager)
        {
            ...
            EntityZombieDinnerbone entityzombie = new EntityZombieDinnerbone(this.worldObj);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        {
            p_110161_1_1 = new EntityZombieDinnerbone.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_110161_1_1 instanceof EntityZombieDinnerbone.GroupData)
        {
            EntityZombieDinnerbone.GroupData groupdata = (EntityZombieDinnerbone.GroupData)p_110161_1_1;
