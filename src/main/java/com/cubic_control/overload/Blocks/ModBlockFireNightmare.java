...
public class ModBlockFireNightmare extends BlockFire
{
    @Deprecated
    ...
    protected ModBlockFireNightmare(String string)
    {
        super();
    ...
    public void onBlockAdded(World world, int x, int y, int z){
        if (!SomeModUtils.isValidDimension(world) || !ModBlockPortalNightmare.getPortalSize(world, x, y, z)){
            if (!World.doesBlockHaveSolidTopSurface(world, x, y - 1, z) && !this.canNeighborBurn(world, x, y, z)){
                world.setBlockToAir(x, y, z);
            } else {
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_) && !((BlockFire) MBlocks.nightmare_fire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_, UP))
        {
            if (((BlockFire) MBlocks.nightmare_fire).canCatchFire(p_149734_1_, p_149734_2_ - 1, p_149734_3_, p_149734_4_, EAST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockFire) MBlocks.nightmare_fire).canCatchFire(p_149734_1_, p_149734_2_ + 1, p_149734_3_, p_149734_4_, WEST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockFire) MBlocks.nightmare_fire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ - 1, SOUTH))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockFire) MBlocks.nightmare_fire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ + 1, NORTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
            ...
            if (((BlockFire) MBlocks.nightmare_fire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ + 1, p_149734_4_, DOWN))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
