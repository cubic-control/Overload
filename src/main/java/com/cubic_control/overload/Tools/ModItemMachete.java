...
public class ModItemMachete extends ItemMachete
{
	...
	public ModItemMachete(ToolMaterial p_i45356_1_, String string, String TexName, ItemStack stack) {
		super(p_i45356_1_);
		this.setCreativeTab(MCreativeTabs.tabWeapons);
        this.setUnlocalizedName(string);
        this.setTextureName(RefStrings.MODID + ":" + TexName);
	...
	public ModItemMachete(ToolMaterial p_i45356_1_, String string, ItemStack stack) {
		super(p_i45356_1_);
		this.setCreativeTab(MCreativeTabs.tabWeapons);
        this.setUnlocalizedName(string);
        this.setTextureName(RefStrings.MODID + ":" + string);
