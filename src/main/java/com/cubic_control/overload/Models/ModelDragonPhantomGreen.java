...
public class ModelDragonPhantomGreen extends ModelBase
{
    ...
    public ModelDragonPhantomGreen(float par1)
    {
    ...
    {
        GL11.glPushMatrix();
        EntityDragonPhantomGreen entitydragon = (EntityDragonPhantomGreen)par1Entity;
