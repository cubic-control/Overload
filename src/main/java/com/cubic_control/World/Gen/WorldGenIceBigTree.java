...
public class WorldGenIceBigTree extends WorldGenIceAbstractTree
{
	private static Block log = MBlocks.ice_log;
	private static Block leaves = MBlocks.ice_leaves;
	...
	public WorldGenIceBigTree(boolean p_i2008_1_, int treeHeight, int trunkWidth, int leavesWidthFromBase)
	{
		super(p_i2008_1_);
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int i1 = par2 + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.func_150529_a(par1, l, par3, f, (byte)1, MBlocks.ice_leaves);
        }
    }
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.func_150530_a(aint, aint2, MBlocks.ice_log);
            }
        }
    }
	...
	boolean validTreeLocation()
	{
		...
		if (block == MBlocks.ice_grass || block == MBlocks.ice_grass) {
			isSoil = true;
		}
