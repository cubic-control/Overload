...
public class ModelPlayerSlim extends ModelBase
{
    ...
    public ModelPlayerSlim()
    {
        this(0.0F);
    }

    public ModelPlayerSlim(float par1)
    {
        this(par1, 0.0F, 64, 32);
    }

    public ModelPlayerSlim(float par1, float par2, int par3, int par4)
    {
