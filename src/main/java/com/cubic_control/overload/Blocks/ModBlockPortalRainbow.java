...
public class ModBlockPortalRainbow extends BlockBreakable
{
	public static final int[][] field_150001_a = new int[][] {new int[0], {3, 1}, {2, 0}};
	private static final String __OBFID = "CL_00000284";

	public ModBlockPortalRainbow(String name)
	{
	...
	public static boolean getPortalSize(World world, int x, int y, int z) {
		ModBlockPortalRainbow.Size size = new ModBlockPortalRainbow.Size(world, x, y, z, 1);
		ModBlockPortalRainbow.Size size1 = new ModBlockPortalRainbow.Size(world, x, y, z, 2);
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = ModBlockPortalRainbow.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = ModBlockPortalRainbow.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150853_a(int x, int y, int z, int p_150853_4_)
		{
			...
			for (i1 = 0; i1 < 22; ++i1)
			{
				...
				if (block1 != MBlocks.rainbow_block)
				{
					break;
				}
			}
			...
			block = this.worldObj.getBlock(x + j1 * i1, y, z + k1 * i1);
			return block == MBlocks.rainbow_block ? i1 : 0;
		}
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[ModBlockPortalRainbow.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[ModBlockPortalRainbow.field_150001_a[this.field_150865_b][1]];
						...
						if (block == MBlocks.rainbow_portal)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							block = this.worldObj.getBlock(k + Direction.offsetX[ModBlockPortalRainbow.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[ModBlockPortalRainbow.field_150001_a[this.field_150865_b][0]]);

							if (block != MBlocks.rainbow_block)
							{
								break label56;
							}
						}
						...
						{
							block = this.worldObj.getBlock(k + Direction.offsetX[ModBlockPortalRainbow.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[ModBlockPortalRainbow.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[ModBlockPortalRainbow.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[ModBlockPortalRainbow.field_150001_a[this.field_150865_b][1]];

				if (this.worldObj.getBlock(j, k, l) != MBlocks.rainbow_block)
				{
		...
		protected boolean getBlockMaterial(Block block){
			return block.getMaterial() == Material.air || block == MBlocks.rainbow_fire || block == MBlocks.rainbow_portal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.worldObj.setBlock(j, i1, k, MBlocks.rainbow_portal, this.field_150865_b, 2);
				}
			}
		}
	}
